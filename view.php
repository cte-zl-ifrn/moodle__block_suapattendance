...
$PAGE->set_url(new moodle_url('/blocks/presence/view.php'));
$PAGE->set_context(\context_system::instance());
$PAGE->set_title('Vizualizar Presenças');
...
echo $OUTPUT->render_from_template('block_suapattendance/view', $templatecontext);
echo $OUTPUT->footer();